...
class HomeFeedEventCell: UICollectionViewCell {
    ...
    @IBOutlet weak var eventImageViewWidthConstraint: NSLayoutConstraint!
    @IBOutlet weak var eventImageViewHeightConstraint: NSLayoutConstraint!
    
    override func awakeFromNib() {
        super.awakeFromNib()
        // Initialization code
        eventOrganizerProfilePhoto.layer.cornerRadius = 15
    }
